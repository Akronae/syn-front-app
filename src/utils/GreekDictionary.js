...
export default class GreekDictionary
{
    ...
    static DICTIONARY =
    {
        ...
        'βαβυλών': new GreekDictionaryEntry({ gender: GreekGrammar.GENDERS.MASCULINE, declensionNounTable: GreekDeclensionNounTables.WN_WNOS, pos: GreekGrammar.PARTS_OF_SPEECH.PROPER_NOUN, translation: 'Babylon' }),
        ...
        'ἀνήρ': new GreekDictionaryEntry({ gender: GreekGrammar.GENDERS.MASCULINE, declensionNounTable: GreekDeclensionNounTables.HR_EROS, pos: GreekGrammar.PARTS_OF_SPEECH.NOUN, translation: 'man' }),
        get 'ἀνὴρ' () { return GreekDictionary.get('ἀνήρ') },
        ...
        'πρὶν': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.ADVERB, translation: 'before' }),
        'ἢ': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.CONJUNCTION, translation: 'or' }),
        'ἔρχομαι': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to come' }),
        'συνέρχομαι': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to come [together]' }),
        'εὑρίσκω': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to find' }),
        'ἐν': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.PREPOSITION, translation: new Cases({ dative: 'in', genitive: 'inside' }) }),
        'γαστήρ': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.NOUN, declensionNounTable: GreekDeclensionNounTables.HR_EROS, translation: 'stomach' }),
        get 'γαστὴρ' () { return GreekDictionary.get('γαστήρ') },
        'ἔχω': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to have' }),
        'πνεῦμα': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.NOUN, declensionNounTable: GreekDeclensionNounTables.A_ATOS, translation: 'spirit' }),
        'ἅγιος': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.ADJECTIVE, declensionNounTable: GreekDeclensionNounTables.OS_OU, translation: 'holy' }),
        'δίκαιος': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.ADJECTIVE, declensionNounTable: GreekDeclensionNounTables.OS_OU, translation: 'righteous' }),
        'μὴ': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.PARTICLE, translation: 'not' }),
        get 'μή' () { return GreekDictionary.get('μὴ') },
        'θέλω': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to wish' }),
        'δειγματίζω': new GreekDictionaryEntry({ pos: GreekGrammar.PARTS_OF_SPEECH.VERB, declensionVerbTable: GreekDeclensionVerbTables.W, translation: 'to make an example of' }),
